...
if(isset($_GET['from'])){
    $selectedKW = $_GET['from'];
}
else{
    if(date('W') - 1 == 0){
        $selectedYear--;
        $selectedKW = getIsoWeeksInYear($selectedYear);
    }
    else{
        $selectedKW = date('W') - 1;
    }
...
<head>
    ...
    <title>DockB Hamburg - Backend - Statistiken - Daten bearbeiten</title>
    <!-- Favicon -->
            ...
            <div class="row">
                                ...
                                if($row['level'] == 2 || $row['level'] == 3){
                                    echo '<li class="active">
                                            ...
                                            <ul class="drop">
                                                ...
                                                <li class="drop-in active"><a href="#">Daten bearbeiten</a></li>
                                            </ul>
                                        </li>';
                                }
                            ?>
                ...
                <div class="col-xs-9 contents">
                    <div class="main-window">
                        <h1 class="page-title">Statistiken » bearbeiten</h1>
                        <img class="small-logo" src="images/content/dockb_logo_small.png" alt="DockB Hamburg">
                        <div id="inner-window" class="enter-data-1">
                            <h2>Wochenstatistik KW<?php echo $selectedKW."/".$selectedYear; ?></h2>
                            <form action="daten_bearbeiten.php" method="get">
                                <div class="row">
                                    <div class="col-xs-3 form-window calendar">
                                        <select name="years">
                                            <?php
                                    ...
                                    <div class="col-xs-2 form-window calendar">
                                        <input type="number" name="from" min="1" max="52">
                                    </div>
                                    <div class="col-xs-4 calendar">
                                        <p>( aktuelle Woche: <?php echo date('W'); ?> )</p>
                                    </div>
                                </div>
                                <div class="seat-button">
                                    <button type="submit" class="btn further-button">weiter&nbsp;&nbsp;→</button>
                                </div>
                            </form>
                        </div>
